...
beforeEach(() => {
  ...
  (useQuery as ReturnType<typeof vi.fn>).mockImplementation((fn: string) => {
    ...
    if (fn === "getCurationPreview") return { totalResponses: 3, confidence: "directional", recommendations: [{ questionId: "q-preview", text: "Calm conversation starter", score: 1, reasons: [{ dimension: "tone", value: "calm", score: 1, responses: 3, landedWell: 1, fellFlat: 0, wrongVibe: 2, timingOff: 0, isMixed: true, coachCount: 3 }] }] };
