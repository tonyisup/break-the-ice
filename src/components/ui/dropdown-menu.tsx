...
import { Check, ChevronRight, Circle } from "@/components/ui/icons/icons"
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 max-h-[var(--radix-dropdown-menu-content-available-height)] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-md border bg-white p-1 text-gray-900 shadow-md dark:bg-gray-900 dark:text-gray-50",
