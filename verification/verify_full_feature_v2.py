...
def verify_feature(page):
    ...
    expect(like_button).to_have_class(re.compile(r"animate-shake"))
    ...
    expect(heart_icon).not_to_have_class(re.compile(r"text-red-500"))
    ...
    heart_icon = like_button.locator("svg")
    expect(heart_icon).to_have_class(re.compile(r"text-red-500"))
